                  ...
                  {product.colors.map((color) => (
                    <button
                      ...
                      className={`w-8 h-8 rounded-full ${color.value} ${
                        selectedColor === color.name ? 'ring-2 ring-purple-600 ring-offset-2' : ''
                      }`}
                      title={color.name}
                    />
                  ))}
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {relatedProducts.map((product) => (
              <div key={product.id} className="bg-white rounded-lg shadow-md hover:shadow-xl transition duration-300">
